...
module.exports = {
    credentials: {
        ...
        google: {
            // OPTION 1: If using a credential JSON file, enter the path below
            //credential_file: process.env.GOOGLE_APPLICATION_CREDENTIALS || '/Users/munish/projects/cloudsploit/gcp_key.json',
            credential_file: process.env.GOOGLE_APPLICATION_CREDENTIALS || '/var/scan/cloudsploit/gcp_key.json',
            // OPTION 2: If using hard-coded credentials, enter them below
