...
### Generic
```
$ git clone https://github.com/resourcebusy/cloudsploit.git
$ cd cloudsploit
$ npm install
$ ./index.js -h
```
...
$ git clone https://github.com/resourcebusy/cloudsploit.git
$ cd cloudsploit
$ docker build . -t cloudsploit:1
$ docker run -d -v /tmp/gcp_key.json:/var/scan/cloudsploit/gcp_key.json --network=host -v /var/tmp:/var/tmp us-west2-docker.pkg.dev/munish-poc-346419/securityscan/securityscanner
$ 
```
